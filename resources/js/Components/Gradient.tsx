export default function Gradent() {
    return (<>
        <div className="absolute left-0 top-0 -z-10 min-h-screen h-fit w-full overflow-hidden">
            ...
            >
                <div
                    className="relative left-[calc(50%)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-blue-300 to-blue-800 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
                    style={{
                        clipPath:
