                ...
                </div>
                {
                    students && students.length > 0 ? (
                        students.map((student, key) => (
                            <div key={key} className="flex gap-3 border-[1px] p-3 rounded-lg hover:bg-slate-50">
                                ...
                                <div className="block lg:basis-[95%] basis-[75%]">
                                    <div className="flex items-center gap-3">
                                        <a className="basis-[20%]" href="/dashboard/result/sysY-Guu-Jjt/1">
                                        ...
                                        <a href="/dashboard/result/sysY-Guu-Jjt/1" className="basis-[65%]">
