        ...
        <>
            <DashboardLayout>
                ...
                <div className="flex flex-col gap-3 mt-5">
                    <div className="flex gap-3 border-[1px] p-3 rounded-lg hover:bg-slate-50 bg-white">
                        <div className="lg:basis-[5%] basis-[15%]">
                            <img src="/static/kuis.png" alt="logo" width="100%" />
                        </div>
                        <div className="block lg:basis-[95%] basis-[75%]">
                            <a href="/dashboard/lessons/sysY-Guu-Jjt">
                                <p className="text-lg font-semibold text-slate-600">
                                    Sistem Persamaan Linear Dua Variabel
                                </p>
                                <p className="text-sm text-slate-600">
                                    Sistem Persamaan Linear Dua Variabel Kelas
                                    VIII
                                </p>
                            </a>
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex gap-3">
                                    <a href="/play/sysY-Guu-Jjt" target="_blank" className="btn lg:btn-sm btn-xs bg-amber-400 text-white hover:bg-amber-700" >
