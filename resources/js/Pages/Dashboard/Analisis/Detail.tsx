...
export default function Summary({
    ...
    return (
        <DashboardLayout>
            <Head title="Analisis" />
            <div ref={divRef} className="text-sm breadcrumbs">
                <ul>
                    <li>
            ...
            <div style={{ maxWidth: `${divWidth}px` }}>
                ...
                <div className="flex flex-col gap-3 bg-white p-5 border-l-[1px] border-r-[1px] border-b-[1px]">
                    <div className="flex flex-col gap-3 p-3 border-[1px]  mt-5">
                                    ...
                                    <table className="table table-xs border-[1px] min-w-[1000px]">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                {
                                                    validityMultipleChoice.questionsValidity.map((v, i) => (
                                                        <td key={i} className="text-center text-[8px]">
                                                            <div className={`${v.correlationValue == null || v.correlationValue == 0.0 ? 'bg-gray-300 text-black' : (v.validity ? 'bg-green-500 text-white' : 'bg-red-500 text-white')} rounded-lg font-semibold py-1 px-2 w-fit mx-auto`}>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                </td>
                                                {
                                                    validityEssay.questionsValidity.map((v, i) => (
                                                        <td key={i} className="text-center text-[8px]">
                                                            <div className={`${v.correlationValue == null || v.correlationValue == 0.0 ? 'bg-gray-300 text-black' : (v.validity ? 'bg-green-500 text-white' : 'bg-red-500 text-white')} rounded-lg font-semibold px-2 py-1 w-fit mx-auto`}>
                                                                {v.correlationValue == null || v.correlationValue == 0.0 ? v.validity : (v.validity ? 'Valid' : 'Tidak Valid')}
                                                            </div>
                                                        </td>
                                                    ))
